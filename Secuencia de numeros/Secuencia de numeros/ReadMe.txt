========================================================================
    APLICACIÓN DE CONSOLA: Secuencia de numeros Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Secuencia de numeros.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Secuencia de numeros.


Secuencia de numeros.vcxproj
...
Secuencia de numeros.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Secuencia de numeros.pch y un archivo de tipos precompilados llamado StdAfx.obj.
