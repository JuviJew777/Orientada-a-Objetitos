========================================================================
    APLICACIÓN DE CONSOLA: SobrecargaDeOperaciones Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación SobrecargaDeOperaciones.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación SobrecargaDeOperaciones.


SobrecargaDeOperaciones.vcxproj
...
SobrecargaDeOperaciones.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado SobrecargaDeOperaciones.pch y un archivo de tipos precompilados llamado StdAfx.obj.
